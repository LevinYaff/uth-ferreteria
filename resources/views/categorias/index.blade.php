                                        ...
                                        <td class="py-4 px-6 flex">
                                            ...
                                            <form action="{{ route('categorias.destroy', $categoria->id) }}"
                                                ...
                                                <button type="submit" class="text-red-600 hover:text-red-900"
                                                    onclick="return confirm('¿Está seguro de que desea eliminar esta categoría?')">Eliminar</button>
                                            </form>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="4" class="py-4 px-6 text-center">No hay categorías registradas
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
