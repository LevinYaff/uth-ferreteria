        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Total Compras</h3>
                        <p class="text-3xl font-bold text-blue-600 dark:text-blue-400">${{ number_format($estadisticas['total_compras'], 2) }}</p>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Cantidad Compras</h3>
                        <p class="text-3xl font-bold text-green-600 dark:text-green-400">{{ $estadisticas['cantidad_compras'] }}</p>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Compras Pendientes</h3>
                        <p class="text-3xl font-bold text-yellow-600 dark:text-yellow-400">{{ $estadisticas['compras_pendientes'] }}</p>
                    </div>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Compras Canceladas</h3>
                        <p class="text-3xl font-bold text-red-600 dark:text-red-400">{{ $estadisticas['compras_canceladas'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium mb-4">Listado de Compras</h3>
                            ...
                            <tbody>
                                @foreach($compras as $compra)
                                    <tr class="border-b border-gray-200 dark:border-gray-600">
                                        ...
                                        <td class="py-4 px-6">{{ $compra->user->name }}</td>
