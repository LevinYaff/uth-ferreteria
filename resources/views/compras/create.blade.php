        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('compras.store') }}" enctype="multipart/form-data" id="formularioCompra">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="fecha_compra" id="fecha_compra" value="{{ old('fecha_compra', date('Y-m-d')) }}" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm" required>
                                @error('fecha_compra')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="numero_factura" id="numero_factura" value="{{ old('numero_factura') }}" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="numero_orden" id="numero_orden" value="{{ old('numero_orden') }}" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">
                                @error('numero_orden')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <table class="min-w-full bg-white dark:bg-gray-700">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-3 px-6">
                                                <input type="number" name="impuestos" id="impuestos" min="0" step="0.01" value="{{ old('impuestos', '0.00') }}" class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="py-3 px-6">
                                                <input type="number" name="descuento" id="descuento" min="0" step="0.01" value="{{ old('descuento', '0.00') }}" class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="observaciones" id="observaciones" rows="3" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm">{{ old('observaciones') }}</textarea>
                            @error('observaciones')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
