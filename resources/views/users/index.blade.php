                    ...
                    <div class="overflow-x-auto">
                        ...
                        <table class="min-w-full bg-white dark:bg-gray-800 border dark:border-gray-700">
                            ...
                            <tbody>
                                            ...
                                            @if ($user->id !== auth()->id())
                                                <form action="{{ route('users.destroy', $user->id) }}" method="POST"
                                                    ...
                                                    <button type="submit" class="text-red-600 hover:text-red-900"
                                                        onclick="return confirm('¿Está seguro de que desea eliminar este usuario? Esta acción no se puede deshacer.')">Eliminar</button>
                                                </form>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5" class="py-4 px-6 text-center">No hay usuarios registrados
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
